...
from .util import get_uuid_from_weaviate_url, get_domain_from_weaviate_url, is_weaviate_entity_url
from requests.exceptions import ConnectionError
from weaviate import SEMANTIC_TYPE_ACTIONS, SEMANTIC_TYPE_THINGS


def add_reference_to_entity(self, from_semantic_type, from_entity_uuid, from_property_name, to_semantic_type,
                            to_entity_uuid, to_weaviate="localhost"):
...
def add_reference_from_action_to_action(self, from_action_uuid, from_property_name, to_action_uuid,
...
def add_reference_from_thing_to_thing(self, from_thing_uuid, from_property_name, to_thing_uuid,
                                      to_weaviate="localhost"):
