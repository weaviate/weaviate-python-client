...
class _CollectionBackupAsync:
    ...
    async def get_create_status(self, backup_id: str, backend: BackupStorage) -> BackupStatusReturn:
        ...
        """
        return await self.__backup.get_create_status(backup_id, backend)
    ...
    async def get_restore_status(
        ...
        """
        return await self.__backup.get_restore_status(backup_id, backend)
