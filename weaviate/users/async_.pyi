...
class _BaseAsync(_BaseExecutor[ConnectionAsync]):
    ...
    async def _revoke_roles_from_user(
        self, roles: str | list[str], user_id: str, user_type: Optional[USER_TYPE]
    ) -> None: ...
...
class _UsersOIDCAsync(_UsersOIDCExecutor[ConnectionAsync]):
    ...
    async def assign_roles(self, *, user_id: str, role_names: str | list[str]) -> None: ...
    async def revoke_roles(self, *, user_id: str, role_names: str | list[str]) -> None: ...
