...
class Value(_message.Message):
    __slots__ = ["number_value", "string_value", "bool_value", "object_value", "list_value", "date_value", "uuid_value", "int_value", "geo_value"]
