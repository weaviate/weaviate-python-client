...
class ObjectPropertiesValue(_message.Message):
    __slots__ = ["non_ref_properties", "number_array_properties", "int_array_properties", "text_array_properties", "boolean_array_properties", "object_properties", "object_array_properties"]
