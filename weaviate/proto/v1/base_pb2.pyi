...
class VectorType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    VECTOR_TYPE_FP32: _ClassVar[VectorType]
    VECTOR_TYPE_COLBERT_FP32: _ClassVar[VectorType]
...
VECTOR_TYPE_FP32: VectorType
VECTOR_TYPE_COLBERT_FP32: VectorType
...
class Vectors(_message.Message):
    ...
    vector_bytes: bytes
    type: VectorType
    def __init__(self, name: _Optional[str] = ..., index: _Optional[int] = ..., vector_bytes: _Optional[bytes] = ..., type: _Optional[_Union[VectorType, str]] = ...) -> None: ...
