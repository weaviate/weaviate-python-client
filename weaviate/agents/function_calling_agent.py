...
class WeaviateFunctionCallingAgentResponse(BaseModel):
    original_query: str
    collection_names: list[str]
    weaviate_queries: list[list[dict]]
    usage: Usage
    total_time: float
    response: str
...
class QueryAgent:
    ...
    def run(
    ...
    ) -> WeaviateFunctionCallingAgentResponse:
        ...
        Returns:
            A WeaviateFunctionCallingAgentResponse object containing search results and analysis
        """
        request_body = {
            "query": query,
        ...
        return WeaviateFunctionCallingAgentResponse(**response.json())