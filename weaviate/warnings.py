...
class _Warnings:
    ...
    def old_reference_to() -> None:
        warnings.warn(
            message="""Dep011: You are using the old Reference.to() method. Please instead only supply raw UUIDs to the methods that require them.""",
            category=DeprecationWarning,
            stacklevel=1,
        )
    ...
    def old_reference_to_multi_target() -> None:
        warnings.warn(
            message="""Dep012: You are using the old Reference.to_multi_target() method. Please instead use the ReferenceToMulti class.""",
            category=DeprecationWarning,
            stacklevel=1,
        )
