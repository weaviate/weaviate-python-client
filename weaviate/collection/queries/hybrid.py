...
class _HybridGenerate(_Grpc):
    def hybrid(
        ...
        """Search for objects in this collection using the hybrid algorithm blending keyword-based BM25 and vector-based similarity  and perform retrieval-augmented generation (RaG) on the results.
