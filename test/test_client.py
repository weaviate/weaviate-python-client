...
class TestWeaviateClient(unittest.TestCase):
        ...
        with patch(
            ...
            mock_obj.assert_called_with(
                connection_params=ConnectionParams(
                    http=ProtocolParams(host="localhost", port=8080, secure=False), grpc=None
                ),
                auth_client_secret=None,
                timeout_config=(1, 2),
                proxies=None,
            ...
            with patch(
                ...
                with patch("weaviate.embedded.EmbeddedDB.start") as mocked_start:
                    ...
                    self.assertEqual(
                        ...
                        ConnectionParams.from_url("http://localhost:8079", 50051),
                    )
    ...
    def test_timeout_config(self, mock_get_meta):
        ...
        """
        connection_params = ConnectionParams.from_url("http://some_url.com:80")
