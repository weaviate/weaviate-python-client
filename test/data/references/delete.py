...
class TestRemoveReference(unittest.TestCase):
    ...
    def test_delete_reference_from_thing(self):
        ...
        w.data_object.reference.add("7591be77-5959-4386-9828-423fc5096e87",
        ...
        self.assertEqual("/things/7591be77-5959-4386-9828-423fc5096e87/references/myProperty", call_args[0])
        self.assertEqual(REST_METHOD_DELETE, call_args[1])
