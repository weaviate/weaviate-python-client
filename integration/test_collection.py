...
def test_hybrid_near_vector_search(collection_factory: CollectionFactory) -> None:
    ...
    if collection._connection._weaviate_version.is_lower_than(1, 25, 0):
        with pytest.raises(WeaviateUnsupportedFeatureError):
            collection.query.hybrid(
                query=None,
                vector=wvc.query.HybridVector.nearvector(vector=obj.vector["default"]),
            ).objects
        return
    ...
    hybrid_objs2 = collection.query.hybrid(
        query=None,
        vector=wvc.query.HybridVector.nearvector(
...
def test_hybrid_near_vector_search_named_vectors(collection_factory: CollectionFactory) -> None:
    ...
    hybrid_objs = collection.query.hybrid(
        query=None,
        vector=wvc.query.HybridVector.nearvector(vector=obj.vector["text"], target_vector="text"),
    ).objects
...
def test_hybrid_near_text_search(collection_factory: CollectionFactory) -> None:
    ...
    if collection._connection._weaviate_version.is_lower_than(1, 25, 0):
        with pytest.raises(WeaviateUnsupportedFeatureError):
            collection.query.hybrid(
                query=None,
                vector=wvc.query.HybridVector.neartext(query="banana pudding"),
            ).objects
        return
    ...
    hybrid_objs2 = collection.query.hybrid(
        query=None,
        vector=wvc.query.HybridVector.neartext(
            query="banana",
...
def test_hybrid_near_text_search_named_vectors(collection_factory: CollectionFactory) -> None:
    ...
    hybrid_objs = collection.query.hybrid(
        query=None,
        vector=wvc.query.HybridVector.neartext(query="banana pudding", target_vector="text"),
    ).objects
