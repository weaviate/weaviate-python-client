...
def test_mono_references_grpc(client: weaviate.CollectionClient):
...
def test_mono_references_grpc_typed_dicts(client: weaviate.CollectionClient):
...
def test_multi_references_grpc(client: weaviate.CollectionClient):
...
def test_references_batch(client: weaviate.CollectionClient):
...
def test_references_batch_with_errors(client: weaviate.CollectionClient):
...
def test_references_with_string_syntax(client: weaviate.CollectionClient):
