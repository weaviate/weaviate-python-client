...
def test_collection_list(client: weaviate.CollectionClient):
...
def test_collection_get_simple(client: weaviate.CollectionClient):
    client.collection.create(
...
def test_collection_config_empty(client: weaviate.CollectionClient):
...
def test_collection_config_defaults(client: weaviate.CollectionClient):
    collection = client.collection.create(
...
def test_collection_config_full(client: weaviate.CollectionClient):
    collection = client.collection.create(
